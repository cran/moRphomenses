...
#' @name mm_data
#' @docType data
#' @format A matrix with 2015 obs (rows) and 4 variables (columns).
#' \describe{
#'
#'   \item{ID}{Individual id, each integer represents a different individual.}
#'   \item{CYCLEDAY}{Integer day of cycle. Generally runs from 1 ... (28 on average).}
